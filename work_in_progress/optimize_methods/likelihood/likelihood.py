...
def get_ams(p_PDFInterpol, p_Nsmooth):
  ...
  #likelihood_options="TransformOutput:PDFInterpol=Spline"+str(p_PDFInterpol)+":NSmoothSig[0]="+str(p_Nsmooth)+":NSmoothBkg[0]=20:NSmooth=5:NAvEvtPerBin=50:VarTransform=Decorrelate"
  ...
  file_name_appendix="_spline"+str(p_PDFInterpol)+"_smooth"+str(p_Nsmooth)
...
if __name__ == '__main__':
  ...
  PDFInterpols = [2]		#default: 2
  Nsmooths = [20]		#default: 20
  ...
  with open(out_file_name, "a") as out_file:
	...
	ams=get_ams(PDFInterpol, Nsmooth)
	out_file.write(str(PDFInterpol)+"\t"+str(Nsmooth)+"\t"+str(ams[0])+"\t"+str(ams[1])+"\n")
	out_file.flush()
